...
<a href="https://github.com/DSTBP/NDBR" title="点击访问">
  ...
  ### 1. 直接安装（推荐）
  - **[点击此处安装最新版本脚本](https://greasyfork.org/zh-CN/scripts/561380-notion-database-batch-replace)**
  ...
  4. 将本仓库中 `Notion Database Batch Replace.user.js` 的**全部代码**复制并粘贴进去。
...
**演示动画**
  ...
  - **v1.0.0**：优化 UI 锚定逻辑，引入 Z 字形自动滚动扫描引擎。
  - **v1.0.1**：修复输入框快捷键被 Notion 劫持的问题。